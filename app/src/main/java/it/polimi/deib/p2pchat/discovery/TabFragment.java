...
public class TabFragment extends Fragment {
    ...
    public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                return wiFiP2pServicesFragment; //the first fragment reserved to the serviceListFragment (To show List of discoverd devices)
            } else {
                return wiFiChatFragmentList.get(position - 1); //chatFragments associated to this position (corresponds to the list of connected devices)
            }
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return ("List of Devices").toUpperCase(l);
                default:
...
//                    }
                    //use this to be sure
                    return ("Device " + position).toUpperCase(l);
            }
        }
    }
}
