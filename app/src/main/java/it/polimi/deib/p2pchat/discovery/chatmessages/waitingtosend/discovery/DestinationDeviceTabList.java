...
import it.polimi.deib.p2pchat.discovery.chatmessages.waitingtosend.discovery.utilities.UseOnlyPrivateHere;
/*
...
/**
 * Class that represent the tab's list associated to {@link WiFiChatFragment}
 * <p></p>
 ...
 * {@link P2pDestinationDevice} index.
 * Because the first tab is reserved to {@link WiFiP2pServicesFragment}.
 * <p></p>
...
public class DestinationDeviceTabList {
    ...
    /**
     * Method that sets a {@link P2pDestinationDevice}
     ...
     * @param device {@link P2pDestinationDevice}
    ...
    /**
     * Method to add a {@link P2pDestinationDevice}
    ...
    /**
     * Method that check if a {@link P2pDestinationDevice}
     * is in the {@link #deviceList}.
     * If the device parameter is null, this method returns false!
     * @param device WifiP2p{@link P2pDestinationDevice} element.
    ...
    /**
     * Method to get the index position of a {@link P2pDestinationDevice}
     ...
     * @param device {@link P2pDestinationDevice} element.
