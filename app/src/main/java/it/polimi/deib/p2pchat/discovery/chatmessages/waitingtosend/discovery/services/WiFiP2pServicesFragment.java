...
package it.polimi.deib.p2pchat.discovery.chatmessages.waitingtosend.discovery.services;
...
import it.polimi.deib.p2pchat.discovery.chatmessages.waitingtosend.discovery.services.localdeviceguielement.LocalDeviceDialogFragment;
 ...
 * If you click on the local device cardview, a {@link LocalDeviceDialogFragment}
...
public class WiFiP2pServicesFragment extends Fragment implements
    ...
    /**
     * Callback interface to call methods tryToConnectToAService in {@link MainActivity}.
    ...
    /**
     * Method called by {@link WiFiServicesAdapter}
     * with the {@link WiFiServicesAdapter.ItemClickListener}
     ...
     * It's useful to open the {@link LocalDeviceDialogFragment}
